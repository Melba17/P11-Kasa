  ...
  return (
    <header className="header">
      ...
      <nav className="header__nav">
        {/* <NavLink> est un composant de react-router-dom et utilisé pour créer des liens de navigation (en gérant l'état actif contrairement au <Link>) dans une application React avec un système de routage => génère, sous le "capot", un élément <a> dans le DOM, d'où la réaction de a en scss et ajoute automatiquement une classe CSS (className au lien actif */}
