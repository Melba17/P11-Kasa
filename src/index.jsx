// Importation de la bibliothèque React pour utiliser ses fonctionnalités (syntaxe JSX et composants React)
...
ReactDOM.createRoot(document.getElementById('root')).render(
  // Utilisation de React.StrictMode pour activer des vérifications et avertissements supplémentaires en mode développement en signalant des méthodes dépréciées => console / double certaines exécutions pour trouver des erreurs liées aux effets secondaires (comme avec useEffect par exemple mais ce hook n'est pas utilisé dans ce projet) / est automatiquement ignoré en production / peut être utilisé autour de toute l'application comme ici ou uniquement autour de composants spécifiques 
  <React.StrictMode>
